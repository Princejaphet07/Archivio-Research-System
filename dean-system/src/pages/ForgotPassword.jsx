...
import bgTexture from '../assets/Rectangle 9 (1).png';
...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen flex font-sans text-stone-800" style={{ backgroundImage: `url("${bgTexture}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="w-full flex justify-center items-center p-6 bg-black/30 backdrop-blur-sm">
        <div className="bg-white/95 rounded-2xl shadow-2xl w-full max-w-md p-8 relative border-t-4 border-[#7a1f3d]">
          
          <div className="flex flex-col items-center mb-6">
            <div className="w-16 h-16 bg-[#7a1f3d] rounded-full flex items-center justify-center border-2 border-[#d0a36e] mb-4 shadow-lg">
          ...
          <div className="text-center mt-6 pt-4 border-t border-stone-100">
            <Link to="/login" className="text-xs font-bold text-stone-500 hover:text-[#7a1f3d] transition-colors">
              ← Back to Login
            </Link>
          </div>
