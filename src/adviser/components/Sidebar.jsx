    ...
    <div className="w-64 bg-[#541b2f] text-white flex flex-col h-full shadow-xl hidden md:flex z-20">
      ...
      <div className="flex-1 overflow-y-auto px-4 custom-scrollbar">
        ...
        <div className="mb-4">
          ...
          <Link to="/adviser/research-categories" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition ${path === '/adviser/research-categories' ? activeClass : inactiveClass}`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mb-4">
          ...
          <Link to="/adviser/send-invitations" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition ${path === '/adviser/send-invitations' ? activeClass : inactiveClass}`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mb-4">
          ...
          <Link to="/adviser/my-profile" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition ${path === '/adviser/my-profile' ? activeClass : inactiveClass}`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
