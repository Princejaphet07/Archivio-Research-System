...
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    if (isChunkError) {
      const pageHasBeenForceRefreshed = JSON.parse(
        window.sessionStorage.getItem('archivio_chunk_reload_adviser') || 'false'
      );
      if (!pageHasBeenForceRefreshed) {
        window.sessionStorage.setItem('archivio_chunk_reload_adviser', 'true');
  ...
  handleReload = () => {
    window.sessionStorage.removeItem('archivio_chunk_reload_adviser');
