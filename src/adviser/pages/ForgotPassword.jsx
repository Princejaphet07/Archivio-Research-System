                ...
                <div className="flex justify-between gap-2">
                  {otp.map((data, index) => (
                    <input
                      ...
                      className="w-12 h-14 bg-[#faf7f5] border border-gray-200 rounded-lg text-center text-2xl text-gray-800 font-semibold focus:outline-none focus:border-[#7a2e46] transition shadow-sm"
                      required
                    />
                  ))}
                </div>
