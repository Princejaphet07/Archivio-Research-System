            ...
            <form onSubmit={handleVerifyOTP}>
              <div className="mb-6">
                ...
                <div className="flex justify-between gap-2">
                  {otp.map((data, index) => {
                    let boxColorClass = "bg-[#faf7f5] border-gray-200 text-gray-800 focus:border-[#7a2e46]";
                    ...
                    return (
                      <input
                        ...
                        className={`w-12 h-14 border rounded-lg text-center text-2xl font-semibold focus:outline-none transition shadow-sm ${boxColorClass}`}
                        required
              ...
              <button
                ...
                className="w-full bg-[#7a2e46] hover:bg-[#5f2135] text-white font-semibold py-3 px-4 rounded-lg transition duration-200 text-sm shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {otpStatus === 'verifying' ? 'Verifying...' : 'Verify Code'}
              </button>
              <div className="text-center mt-4">
                <button type="button" onClick={() => { setStep(1); setOtpStatus('idle'); setOtp(new Array(6).fill('')); }} className="text-xs text-[#7a2e46] hover:underline">
                  Resend Code
                </button>
              </div>
            </form>
