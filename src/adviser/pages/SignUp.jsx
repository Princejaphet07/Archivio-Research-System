...
function SignUp() {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full rounded-2xl border border-white/50 bg-white/95 p-6 shadow-2xl backdrop-blur-md relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-3 mb-2">
            <div>
              ...
              <input name="firstName" value={formData.firstName} onChange={handleChange} type="text" placeholder="e.g. Maria" 
                className={`w-full border border-stone-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7a1f3d]/20 focus:border-[#7a1f3d] transition-all disabled:opacity-50 ${isPrefilled ? 'bg-stone-100 text-stone-500 cursor-not-allowed' : 'bg-white'}`} 
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-white border border-stone-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7a1f3d]/20 focus:border-[#7a1f3d] transition-all disabled:opacity-50" 
