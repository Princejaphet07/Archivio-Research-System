...
export default function ActivateAccount() {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full rounded-2xl border border-white/50 bg-white/95 p-8 shadow-2xl backdrop-blur-md relative overflow-hidden transition-colors">
