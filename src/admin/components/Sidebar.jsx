          ...
          <div>
            ...
            <nav className="space-y-1">
              ...
              <NavButton
                ...
                label="Dashboard"
                icon={
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/dashboard' && canAccess('dashboard') ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              ...
              {!isSuperAdmin && (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer ${location.pathname === '/admin/user-management' ? 'bg-white/[0.06] text-white border-l-2 border-[#d6ad60]' : 'text-stone-400 hover:bg-white/[0.02] hover:text-white'}`}
                >
                  <div className="flex items-center gap-2.5">
                    <svg className={`w-4 h-4 ${location.pathname === '/admin/user-management' ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <nav className="space-y-1">
              <NavButton
                ...
                label="All Users"
                icon={
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/all-users' && canAccess('allUsers') ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              ...
              <NavButton
                ...
                label="Activity Logs"
                icon={
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/activity-logs' && canAccess('activityLogs') ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              ...
              <NavButton
                ...
                label="Reports"
                icon={
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/reports' && canAccess('reports') ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          {!isSuperAdmin ? (
            <div>
              ...
              <nav className="space-y-1">
                ...
                >
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/settings' ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <nav className="space-y-1">
                <button
                  onClick={() => navigate('/admin/super-admin-settings')}
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer ${
                    location.pathname === '/admin/super-admin-settings'
                      ? 'bg-white/[0.06] text-white border-l-2 border-[#d6ad60]'
                      : 'text-stone-400 hover:bg-white/[0.02] hover:text-white'
                  }`}
                >
                  <svg className={`w-4 h-4 ${location.pathname === '/admin/super-admin-settings' ? 'text-[#d6ad60]' : 'text-stone-400'}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
