          ...
          {step === 1 && (
            <form onSubmit={handleSendOTP}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#801e38] hover:bg-[#601328] disabled:opacity-60 text-white font-bold py-3.5 px-4 rounded-xl transition duration-200 text-sm shadow-md"
              >
            ...
            <form onSubmit={handleVerifyOTP}>
              <div className="mb-6">
                ...
                <div className="flex justify-between gap-2">
                  {otp.map((data, index) => {
                    let boxColorClass = "bg-[#fbfaf8] border-stone-200 dark:border-stone-700 text-stone-800 focus:border-[#801e38] focus:ring-[#801e38]";
                    ...
                    return (
                      <input
                        ...
                        className={`w-12 h-14 border rounded-xl text-center text-2xl font-semibold focus:outline-none focus:ring-1 transition-all shadow-sm ${boxColorClass}`}
                        required
              ...
              <button
                ...
                className="w-full bg-[#801e38] hover:bg-[#601328] text-white font-bold py-3.5 px-4 rounded-xl transition duration-200 text-sm shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {otpStatus === 'verifying' ? 'Verifying...' : 'Verify Code'}
              </button>
              <div className="text-center mt-4">
                <button type="button" onClick={() => { setStep(1); setOtpStatus('idle'); setOtp(new Array(6).fill('')); }} className="text-xs text-[#801e38] font-bold hover:underline">
                  Resend Code
                </button>
              </div>
            </form>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-[#fbfaf8] border border-stone-200 dark:border-stone-700 rounded-xl text-sm focus:outline-none focus:border-[#801e38] focus:ring-1 focus:ring-[#801e38] transition-all mb-3 select-none"
                    required
                    disabled={loading}
                    data-password="true"
                    data-no-copy="true"
                  ...
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-3 text-[10px] font-bold text-[#801e38] hover:text-[#601328]">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-[#fbfaf8] border border-stone-200 dark:border-stone-700 rounded-xl text-sm focus:outline-none focus:border-[#801e38] focus:ring-1 focus:ring-[#801e38] transition-all select-none"
                    required
                    disabled={loading}
                    data-password="true"
                    data-no-copy="true"
                    ...
                    onContextMenu={(e) => { e.preventDefault(); return false; }}
                  />
                  <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[10px] font-bold text-[#801e38] hover:text-[#601328]">
